...
export const RulerIcon: React.FC<IconProps> = ({ size = 24, className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round">
    <path d="M21 6H3M6 12H3M6 18H3M12 12H9M12 18H9M18 12h-3M18 18h-3M21 6v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2z" />
  </svg>
)

export const ScaleIcon: React.FC<IconProps> = ({ size = 24, className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round">
    <path d="M12 3v18M5 21h14M6 8h12M8 8v4M16 8v4" />
  </svg>
)
