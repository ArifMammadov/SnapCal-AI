...
const apiMessages = {
  ...
  subscription_active: {
    en: 'SnapCal Pro is active. Enjoy unlimited food scans and AI chat.',
    ru: 'Подписка SnapCal Pro активна. Безлимитный анализ еды и общение с AI.',
    uz: 'SnapCal Pro obunasi faol. Cheksiz ovqat tahlili va AI suhbati.',
    kk: 'SnapCal Pro жазылысы белсенді. Шексіз тағам талдауы және AI сөйлесуі.',
    az: 'SnapCal Pro abunəliyi aktivdir. Limitsiz qida təhlili və AI söhbəti.',
    tr: 'SnapCal Pro aboneliği aktif. Sınırsız yiyecek taraması ve AI sohbetinin keyfini çıkarın.',
    ar: 'اشتراك SnapCal Pro نشط. استمتع بتحليل الطعام غير المحدود والدردشة الذكية.',
  },
  subscription_trial: {
    en: 'SnapCal Pro trial is active. Days left: {{days}}.',
    ru: 'Пробный период SnapCal Pro активен. Осталось дней: {{days}}.',
    uz: 'SnapCal Pro sinov muddati faol. Qolgan kunlar: {{days}}.',
    kk: 'SnapCal Pro сынақ мерзімі белсенді. Қалған күндер: {{days}}.',
    az: 'SnapCal Pro sınaq müddəti aktivdir. Qalan günlər: {{days}}.',
    tr: 'SnapCal Pro deneme süresi aktif. Kalan gün: {{days}}.',
    ar: 'فترة تجربة SnapCal Pro نشطة. الأيام المتبقية: {{days}}.',
  },
  subscription_free: {
    en: 'Free plan: 1 photo scan per day. Upgrade to SnapCal Pro for unlimited access.',
    ru: 'Бесплатный тариф: 1 анализ фото в день. Оформите SnapCal Pro для безлимитного доступа.',
    uz: 'Bepul tarif: kuniga 1 ta rasm tahlili. Cheksiz kirish uchun SnapCal Pro obunasini rasmiylashtiring.',
    kk: 'Тегін тариф: күніне 1 сурет талдауы. Шексіз қол жетімділік үшін SnapCal Pro жазылысын рәсімдеңіз.',
    az: 'Pulsuz tarif: gündə 1 şəkil təhlili. Limitsiz giriş üçün SnapCal Pro abunəliyi əldə edin.',
    tr: 'Ücretsiz plan: günde 1 fotoğraf taraması. Sınırsız erişim için SnapCal Pro satın alın.',
    ar: 'الخطة المجانية: مسح صورة واحد يوميًا. قم بالترقية إلى SnapCal Pro للوصول غير المحدود.',
  },
  daily_scan_limit: {
    en: 'Free photo scan limit reached today. Upgrade to SnapCal Pro for unlimited scans.',
    ru: 'Бесплатный лимит анализа фото на сегодня исчерпан. Оформите SnapCal Pro для безлимитного доступа.',
    uz: 'Bugun bepul rasm tahlili limiti tugadi. Cheksiz tahlil uchun SnapCal Pro obunasini rasmiylashtiring.',
    kk: 'Бүгінгі тегін сурет талдауы лимиті аяқталды. Шексіз талдау үшін SnapCal Pro жазылысын рәсімдеңіз.',
    az: 'Bugün pulsuz şəkil təhlili limiti bitdi. Limitsiz təhlil üçün SnapCal Pro abunəliyi əldə edin.',
    tr: 'Ücretsiz günlük fotoğraf tarama limitine ulaşıldı. Sınırsız tarama için SnapCal Pro satın alın.',
    ar: 'تم الوصول إلى الحد الأقصى المجاني لمسح الصور اليوم. قم بالترقية إلى SnapCal Pro للمسح غير المحدود.',
  },
  plan_not_found: {
    en: 'Subscription plan not found.',
    ru: 'План подписки не найден.',
    uz: 'Obuna rejasi topilmadi.',
    kk: 'Жазылыс жоспары табылмады.',
    az: 'Abunə planı tapılmadı.',
    tr: 'Abonelik planı bulunamadı.',
    ar: 'خطة الاشتراك غير موجودة.',
  },
  invoice_failed: {
    en: 'Could not create Telegram Stars invoice. Please try again.',
    ru: 'Не удалось создать счёт в Telegram Stars. Попробуйте ещё раз.',
    uz: 'Telegram Stars hisobi yaratilmadi. Qayta urinib koʻring.',
    kk: 'Telegram Stars шотын жасау мүмкін болмады. Қайта байқап көріңіз.',
    az: 'Telegram Stars hesabı yaradıla bilmədi. Zəhmət olmasa, yenidən cəhd edin.',
    tr: 'Telegram Stars faturası oluşturulamadı. Lütfen tekrar deneyin.',
    ar: 'تعذر إنشاء فاتورة Telegram Stars. يرجى المحاولة مرة أخرى.',
  },
  payment_verified: {
    en: 'Payment verified. SnapCal Pro is now active.',
    ru: 'Оплата подтверждена. SnapCal Pro теперь активен.',
    uz: 'Toʻlov tasdiqlandi. SnapCal Pro endi faol.',
    kk: 'Төлем расталды. SnapCal Pro енді белсенді.',
    az: 'Ödəniş təsdiqləndi. SnapCal Pro indi aktivdir.',
    tr: 'Ödeme doğrulandı. SnapCal Pro artık aktif.',
    ar: 'تم التحقق من الدفع. SnapCal Pro نشط الآن.',
  },
  payment_not_found: {
    en: 'Payment not found or not completed.',
    ru: 'Платёж не найден или не завершён.',
    uz: 'Toʻlov topilmadi yoki yakunlanmadi.',
    kk: 'Төлем табылмады немесе аяқталмады.',
    az: 'Ödəniş tapılmadı və ya tamamlanmadı.',
    tr: 'Ödeme bulunamadı veya tamamlanmadı.',
    ar: 'لم يتم العثور على الدفع أو لم يكتمل.',
  },
}
